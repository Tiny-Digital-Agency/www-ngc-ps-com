...
declare module "@prismicio/client" {
    ...
    namespace Content {
        export type { PageDocumentData, PageDocument, AllDocumentTypes, CallToActionSliceDefaultPrimary, CallToActionSliceDefault, CallToActionSliceVariation, CallToActionSlice };
    }
}
