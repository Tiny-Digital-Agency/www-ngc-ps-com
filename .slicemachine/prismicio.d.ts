 ...
 *
 */
type HomepageDocumentDataSlicesSlice = TopNavSlice | HeaderSlice | HeroSectionSlice | AboutSlice | CertificationSlice | TeamProfileSlice | TeamDropdownSlice | FooterSlice | GridSectionSlice | MainSlice;
/**
 ...
 *
 */
type NavigationDocumentDataSlicesSlice = NavigationItemsSlice;
/**
 ...
 *
 */
type PageDocumentDataSlicesSlice = CallToActionSlice | GridSectionSlice;
/**
...
interface CardsSectionSliceDefaultPrimary {
    ...
    title: prismicT.TitleField;
    /**
     * Description field in *CardsSection → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: cards_section.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    description: prismicT.RichTextField;
...
interface GridSectionSliceDefaultPrimary {
    ...
    title: prismicT.TitleField;
    /**
     * Description field in *GridSection → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: grid_section.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    description: prismicT.RichTextField;
 ...
 *
 */
interface MainSliceDefaultPrimary {
    /**
     * Description field in *Main → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: main.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    description: prismicT.RichTextField;
 ...
 *
 */
export type MainSliceDefault = prismicT.SharedSliceVariation<"default", Simplify<MainSliceDefaultPrimary>, never>;
/**
...
/**
 * Primary content in NavigationItems → Primary
 *
 */
interface NavigationItemsSliceDefaultPrimary {
    /**
     * Name field in *NavigationItems → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: *None*
     * - **API ID Path**: navigation_items.primary.name
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    name: prismicT.RichTextField;
    /**
     * Link field in *NavigationItems → Primary*
     *
     * - **Field Type**: Link
     * - **Placeholder**: *None*
     * - **API ID Path**: navigation_items.primary.link
     * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
     *
     */
...
/**
 * Item in NavigationItems → Items
 *
 */
export interface NavigationItemsSliceDefaultItem {
    /**
     * Name field in *NavigationItems → Items*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: *None*
     * - **API ID Path**: navigation_items.items[].name
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    name: prismicT.RichTextField;
    /**
     * Link field in *NavigationItems → Items*
     *
     * - **Field Type**: Link
     * - **Placeholder**: *None*
     * - **API ID Path**: navigation_items.items[].link
     * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
     *
     */
    link: prismicT.LinkField;
...
/**
 * Default variation for NavigationItems Slice
 *
 * - **API ID**: `default`
 ...
 *
 */
export type NavigationItemsSliceDefault = prismicT.SharedSliceVariation<"default", Simplify<NavigationItemsSliceDefaultPrimary>, Simplify<NavigationItemsSliceDefaultItem>>;
/**
 * Slice variation for *NavigationItems*
 *
 */
type NavigationItemsSliceVariation = NavigationItemsSliceDefault;
/**
 * NavigationItems Shared Slice
 *
 * - **API ID**: `navigation_items`
 * - **Description**: `NavigationItems`
 * - **Documentation**: https://prismic.io/docs/core-concepts/reusing-slices
 *
 */
export type NavigationItemsSlice = prismicT.SharedSlice<"navigation_items", NavigationItemsSliceVariation>;
/**
